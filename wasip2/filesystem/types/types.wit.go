...
import (
	wallclock "go.jcbhmr.com/sys/wasip2/clocks/wall-clock"
	"go.jcbhmr.com/sys/wasip2/io/streams"
	"go.bytecodealliance.org/cm"
)

// InputStream represents the imported type alias "wasi:filesystem/types@0.2.9#input-stream".
//
...
// DescriptorFlags represents the flags "wasi:filesystem/types@0.2.9#descriptor-flags".
//
// Descriptor flags.
//
...
// PathFlags represents the flags "wasi:filesystem/types@0.2.9#path-flags".
//
...
// OpenFlags represents the flags "wasi:filesystem/types@0.2.9#open-flags".
//
...
// NewTimestamp represents the variant "wasi:filesystem/types@0.2.9#new-timestamp".
//
...
// DirectoryEntry represents the record "wasi:filesystem/types@0.2.9#directory-entry".
//
// A directory entry.
//
...
// Advice represents the enum "wasi:filesystem/types@0.2.9#advice".
//
...
// MetadataHashValue represents the record "wasi:filesystem/types@0.2.9#metadata-hash-value".
//
...
// DirectoryEntryStream represents the imported resource "wasi:filesystem/types@0.2.9#directory-entry-stream".
//
