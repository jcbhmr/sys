...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.advise
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.create-directory-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.get-flags
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.is-same-object
//go:noescape
func wasmimport_DescriptorIsSameObject(self0 uint32, other0 uint32) (result0 uint32)

//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.link-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.metadata-hash
//go:noescape
func wasmimport_DescriptorMetadataHash(self0 uint32, result *cm.Result[MetadataHashValueShape, MetadataHashValue, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.metadata-hash-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.open-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.read
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.read-directory
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.rename-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.set-size
//go:noescape
func wasmimport_DescriptorSetSize(self0 uint32, size0 uint64, result *cm.Result[ErrorCode, struct{}, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.set-times
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.set-times-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.stat-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [method]descriptor.symlink-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.9 [resource-drop]directory-entry-stream
//go:noescape
func wasmimport_DirectoryEntryStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:filesystem/types@0.2.9 [method]directory-entry-stream.read-directory-entry
//go:noescape
