...
// Package preopens represents the imported interface "wasi:filesystem/preopens@0.2.9".
package preopens

import (
	"go.jcbhmr.com/sys/wasip2/filesystem/types"
	"go.bytecodealliance.org/cm"
)

// Descriptor represents the imported type alias "wasi:filesystem/preopens@0.2.9#descriptor".
//
