...
// Package streams represents the imported interface "wasi:io/streams@0.2.9".
//
...
// Error represents the imported type alias "wasi:io/streams@0.2.9#error".
//
// See [ioerror.Error] for more information.
type Error = ioerror.Error

// Pollable represents the imported type alias "wasi:io/streams@0.2.9#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// StreamError represents the imported variant "wasi:io/streams@0.2.9#stream-error".
//
...
// InputStream represents the imported resource "wasi:io/streams@0.2.9#input-stream".
//
// An input bytestream.
//
...
// OutputStream represents the imported resource "wasi:io/streams@0.2.9#output-stream".
//
