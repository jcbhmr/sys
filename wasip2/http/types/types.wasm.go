...
//go:wasmimport wasi:http/types@0.2.9 [static]fields.from-list
//go:noescape
func wasmimport_FieldsFromList(entries0 *cm.Tuple[FieldName, FieldValue], entries1 uint32, result *cm.Result[Fields, Fields, HeaderError])
...
//go:wasmimport wasi:http/types@0.2.9 [method]fields.clone
//go:noescape
func wasmimport_FieldsClone(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]fields.delete
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [resource-drop]incoming-request
//go:noescape
func wasmimport_IncomingRequestResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.authority
//go:noescape
func wasmimport_IncomingRequestAuthority(self0 uint32, result *cm.Option[string])

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.consume
//go:noescape
func wasmimport_IncomingRequestConsume(self0 uint32, result *cm.Result[IncomingBody, IncomingBody, struct{}])

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.headers
//go:noescape
func wasmimport_IncomingRequestHeaders(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.method
//go:noescape
func wasmimport_IncomingRequestMethod(self0 uint32, result *Method)

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.path-with-query
//go:noescape
func wasmimport_IncomingRequestPathWithQuery(self0 uint32, result *cm.Option[string])

//go:wasmimport wasi:http/types@0.2.9 [method]incoming-request.scheme
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-request.authority
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-request.headers
//go:noescape
func wasmimport_OutgoingRequestHeaders(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-request.method
//go:noescape
func wasmimport_OutgoingRequestMethod(self0 uint32, result *Method)

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-request.path-with-query
//go:noescape
func wasmimport_OutgoingRequestPathWithQuery(self0 uint32, result *cm.Option[string])

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-request.scheme
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [method]request-options.between-bytes-timeout
//go:noescape
func wasmimport_RequestOptionsBetweenBytesTimeout(self0 uint32, result *cm.Option[Duration])

//go:wasmimport wasi:http/types@0.2.9 [method]request-options.connect-timeout
//go:noescape
func wasmimport_RequestOptionsConnectTimeout(self0 uint32, result *cm.Option[Duration])

//go:wasmimport wasi:http/types@0.2.9 [method]request-options.first-byte-timeout
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [resource-drop]response-outparam
//go:noescape
func wasmimport_ResponseOutparamResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [static]response-outparam.set
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [method]response-outparam.send-informational
//go:noescape
func wasmimport_ResponseOutparamSendInformational(self0 uint32, status0 uint32, headers0 uint32, result *cm.Result[ErrorCode, struct{}, ErrorCode])
...
//go:wasmimport wasi:http/types@0.2.9 [static]incoming-body.finish
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [resource-drop]future-trailers
//go:noescape
func wasmimport_FutureTrailersResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]future-trailers.get
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 [method]future-trailers.subscribe
//go:noescape
func wasmimport_FutureTrailersSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [resource-drop]outgoing-response
//go:noescape
func wasmimport_OutgoingResponseResourceDrop(self0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [constructor]outgoing-response
//go:noescape
func wasmimport_NewOutgoingResponse(headers0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-response.body
//go:noescape
func wasmimport_OutgoingResponseBody(self0 uint32, result *cm.Result[OutgoingBody, OutgoingBody, struct{}])

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-response.headers
//go:noescape
func wasmimport_OutgoingResponseHeaders(self0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-response.set-status-code
//go:noescape
func wasmimport_OutgoingResponseSetStatusCode(self0 uint32, statusCode0 uint32) (result0 uint32)

//go:wasmimport wasi:http/types@0.2.9 [method]outgoing-response.status-code
//go:noescape
...
//go:wasmimport wasi:http/types@0.2.9 http-error-code
//go:noescape
