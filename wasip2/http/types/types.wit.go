...
// Package types represents the imported interface "wasi:http/types@0.2.9".
//
...
import (
	monotonicclock "go.jcbhmr.com/sys/wasip2/clocks/monotonic-clock"
	ioerror "go.jcbhmr.com/sys/wasip2/io/error"
	"go.jcbhmr.com/sys/wasip2/io/poll"
	"go.jcbhmr.com/sys/wasip2/io/streams"
	"go.bytecodealliance.org/cm"
)

// Duration represents the type alias "wasi:http/types@0.2.9#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// InputStream represents the imported type alias "wasi:http/types@0.2.9#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:http/types@0.2.9#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// IOError represents the imported type alias "wasi:http/types@0.2.9#io-error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Pollable represents the imported type alias "wasi:http/types@0.2.9#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Method represents the variant "wasi:http/types@0.2.9#method".
//
...
// Scheme represents the variant "wasi:http/types@0.2.9#scheme".
//
...
// DNSErrorPayload represents the record "wasi:http/types@0.2.9#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.9#TLS-alert-received-payload".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.9#field-size-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.9#error-code".
//
...
// HeaderError represents the variant "wasi:http/types@0.2.9#header-error".
//
...
// FieldKey represents the string "wasi:http/types@0.2.9#field-key".
//
...
// FieldName represents the type alias "wasi:http/types@0.2.9#field-name".
//
// See [FieldKey] for more information.
type FieldName = FieldKey

// FieldValue represents the list "wasi:http/types@0.2.9#field-value".
//
...
// Fields represents the imported resource "wasi:http/types@0.2.9#fields".
//
...
// Headers represents the imported type alias "wasi:http/types@0.2.9#headers".
//
// See [Fields] for more information.
type Headers = Fields

// Trailers represents the imported type alias "wasi:http/types@0.2.9#trailers".
//
// See [Fields] for more information.
type Trailers = Fields

// IncomingRequest represents the imported resource "wasi:http/types@0.2.9#incoming-request".
//
...
// OutgoingRequest represents the imported resource "wasi:http/types@0.2.9#outgoing-request".
//
...
// RequestOptions represents the imported resource "wasi:http/types@0.2.9#request-options".
//
...
// ResponseOutparam represents the imported resource "wasi:http/types@0.2.9#response-outparam".
//
...
// SendInformational represents the imported method "send-informational".
//
...
//
//go:nosplit
func (self ResponseOutparam) SendInformational(status uint16, headers Headers) (result cm.Result[ErrorCode, struct{}, ErrorCode]) {
	self0 := cm.Reinterpret[uint32](self)
	status0 := (uint32)(status)
	headers0 := cm.Reinterpret[uint32](headers)
	wasmimport_ResponseOutparamSendInformational((uint32)(self0), (uint32)(status0), (uint32)(headers0), &result)
	return
}

// StatusCode represents the u16 "wasi:http/types@0.2.9#status-code".
//
...
// IncomingResponse represents the imported resource "wasi:http/types@0.2.9#incoming-response".
//
...
// IncomingBody represents the imported resource "wasi:http/types@0.2.9#incoming-body".
//
...
// FutureTrailers represents the imported resource "wasi:http/types@0.2.9#future-trailers".
//
...
// OutgoingResponse represents the imported resource "wasi:http/types@0.2.9#outgoing-response".
//
...
// OutgoingBody represents the imported resource "wasi:http/types@0.2.9#outgoing-body".
//
...
// FutureIncomingResponse represents the imported resource "wasi:http/types@0.2.9#future-incoming-response".
//
