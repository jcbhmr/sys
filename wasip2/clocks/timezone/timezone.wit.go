...
// Package timezone represents the imported interface "wasi:clocks/timezone@0.2.9".
package timezone
...
// DateTime represents the type alias "wasi:clocks/timezone@0.2.9#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// TimezoneDisplay represents the record "wasi:clocks/timezone@0.2.9#timezone-display".
//
