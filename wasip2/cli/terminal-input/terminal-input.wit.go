...
// Package terminalinput represents the imported interface "wasi:cli/terminal-input@0.2.9".
//
// Terminal input.
//
...
// TerminalInput represents the imported resource "wasi:cli/terminal-input@0.2.9#terminal-input".
//
