...
// Package terminaloutput represents the imported interface "wasi:cli/terminal-output@0.2.9".
//
// Terminal output.
//
...
// TerminalOutput represents the imported resource "wasi:cli/terminal-output@0.2.9#terminal-output".
//
